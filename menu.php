<ul class="nav__main" id="nav__main-small">
    <li onClick="handleOpenNearFooter()" class="logo__category">
    ...
    <li>
        <a href="<?php echo url_for("home"); ?>" class="nav__main-link">
            ...
            <?php } ?>
            <h3 class="main-link__name">Home</h3>
        </a>
    </li>
    <li>
        <a href="<?php echo url_for("explore"); ?>" class="nav__main-link">
            ...
            <h3 class="main-link__name">Explore</h3>
        </a>
    </li>
    <li>
        <a href="<?php echo url_for("i/notification"); ?>" class="nav__main-link global-nav__primary-link-notif">
        <?php if(empty(count((array)$notificationCount))){ ?>
            ...
            <?php } ?>
            <h3 class="main-link__name">Notification</h3>
        </a>
    </li>
    <li>
        <a href="<?php echo url_for("messages"); ?>" class="nav__main-link">
            ...
            <?php } ?>
            <h3 class="main-link__name">Message</h3>
        </a>
    </li>
    <li>
        <a href="<?php echo url_for("profile"); ?>" class="nav__main-link">
            ...
            <?php } ?>
            <h3 class="main-link__name">Profile</h3>
        </a>
    </li>
</ul>
<script>
    function handleOpenNearFooter() {
        if ($(".nav__footer__child").is(":hidden")) 
        $(".nav__footer__child").show();
        else 
        $(".nav__footer__child").hide();
    }
</script>