<section class="wrapper" role="region">
 <header>
    <nav role="navigation" class="global_nav" id="nav">
        ...
        <div class="logout-container">
            ...
            <div class="logout-modal-body">
               <div class="logout-modal-header" role="button" tabindex="0" data-focusable="true">
                 ...
                 <img src="<?php echo url_for('frontend/assets/images/check.svg') ?>" alt="" style="width:20px;margin-left:auto;">
               </div>
